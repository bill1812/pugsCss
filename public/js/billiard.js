  ...
  handleTurnEnd() {
    ...
    if (this.firstContact) {
      ...
      if (this.playersAssigned && !isCue && !isEight) {
        if ((this.currentPlayer.stripes && !ball.stripes) || (this.currentPlayer.solids && !ball.solids)) {
